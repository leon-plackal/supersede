            ...
            <div className='-mt-12 flex items-center h-screen'>
                <div className='w-auto mx-auto md:w-96'>
                    <div>
                        ...
                        {/*            <div>*/}
                        {/*                <label form="email" className="block text-sm mb-2 text-lTextPrimary dark:text-dTextPrimary">Email address</label>*/}
                        ...
                        {/*            <div>*/}
                        {/*                <label form="password" className="block text-sm mb-2 text-lTextPrimary dark:text-dTextPrimary">Password</label>*/}
                        {/*                <div className="relative">*/}
                        ...
                        {/*            /!*<div>*!/*/}
                        {/*            /!*    <label form="confirm-password" className="block text-sm mb-2 dark:text-white">Confirm Password</label>*!/*/}
                        {/*            /!*    <div className="relative">*!/*/}
                        ...
                        {/*                </div>*/}
                        {/*                <div className="ml-3">*/}
                        {/*                    <label form="remember-me" className="text-sm dark:text-white">I accept the <a className="text-blue-600 decoration-2 hover:underline font-medium" href="/">Terms and Conditions</a></label>*/}
                        {/*                </div>*/}
                        {/*            </div>*/}
