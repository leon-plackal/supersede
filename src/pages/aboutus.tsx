    ...
    return (
        <BaseLayout hideNav={true}>
            <div className="py-6 items-center my-auto md:h-full max-w-3xl">
                ...
                <div>
                    <h2 className="text-3xl text-gray-800 font-bold lg:text-4xl dark:text-white mb-6">
                        Our vision
                    </h2>
                ...
                <div className="space-y-6 lg:space-y-10">
                    ...
                    <div >
                        <Link to="/privacy"><span className="hover:text-blue-600">Privacy Policy</span></Link>
                    </div>
                </div>
