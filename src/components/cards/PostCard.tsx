...
const PostCard: FC<PostCardProps> = ({ title, video, link, image, date, Source }) => {
    const [dropdownOpen, setDropdownOpen] = useState<boolean>(false);
    const inactiveNavStyle: string =
        'flex gap-3 py-2 my-2 hover:bg-socialBlue hover:text-white -mx-2 px-2 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-400';
    ...
    return (
        <Card colour="" padding={'none'}  expand={false}>
